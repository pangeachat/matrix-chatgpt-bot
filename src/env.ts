...
export const {
  ...
  /** Pangea Chat Specific */
  PANGEA_CLASSIFIER_PROMPT
  ...
  /** Pangea Chat Specifics */
  PANGEA_CLASSIFIER_PROMPT: { schema: z.string().default(""),                      description: "This is the prompt used to classify whether a specific message is about Pangea Chat or not."}, 
});
